...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_default(
    ...
    KC_PGDN, KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
             ...
             KC_LCTL,          KC_LALT, LGUI_T(KC_SPC),   MO(_FN1),                          KC_SPC,           KC_RALT,                   KC_RCTL
  ),

  [_FN1] = LAYOUT_default(
    RGB_TOG,  _______, KC_F1,   KC_F2,   KC_F3,    KC_F4,       KC_F5,      KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,  KC_DEL,
    RGB_MOD,  _______, _______, KC_UP,   KC__MUTE, KC__VOLDOWN, KC__VOLUP,           KC_MEDIA_PLAY_PAUSE, KC_MEDIA_FAST_FORWARD, KC_MEDIA_FAST_FORWARD, _______, _______, _______, _______, _______,
